...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) values (1, 'Thai Gourmet', 10.0, 1, utc_timestamp, utc_timestamp, true, '50000-000', 'Av. Boa Viagem', '123', 'Apto 101', 'Boa Viagem', 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) values (2, 'Thai Delivery', 9.50, 1, utc_timestamp, utc_timestamp, true, '50010-000', 'Rua das Flores', '456', null, 'Centro', 2);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) values (3, 'Japan Food', 12.50, 2, utc_timestamp, utc_timestamp, true, '58000-000', 'Av. Epitácio Pessoa', '789', 'Sala 12', 'Tambaú', 2);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) values (4, 'Java Stackhouse', 12.0, 3, utc_timestamp, utc_timestamp, true, '30100-000', 'Rua Java', '101', null, 'Savassi', 2);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) values (5, 'Lanchonete do Tio Sam', 11.0, 4, utc_timestamp, utc_timestamp, true, '57000-000', 'Av. América', '202', 'Loja A', 'Pajuçara', 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, endereco_cidade_id) values (6, 'Bar da Maria', 6.0, 4, utc_timestamp, utc_timestamp, true, '57010-000', 'Rua do Sol', '303', null, 'Centro', 1);
